...
import { FaBrain, FaFileAlt, FaSearch, FaGlobe } from 'react-icons/fa';
        ...
        <section className="relative px-6 max-w-5xl mx-auto mb-20 z-10 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    <div key={i} className="bg-card/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl hover:bg-card/10 transition-all group shadow-sm hover:shadow-xl hover:shadow-[#2DD4BF]/5 flex flex-col justify-between">
                        <div>
                            ...
                            <h3 className="text-white font-black uppercase text-xs mb-3 tracking-wider">{item.title}</h3>
                            <p className="text-white/60 text-[10px] font-medium leading-relaxed mb-6">
                                {item.desc}
                            </p>
                        </div>
                        <div className="text-[9px] font-black uppercase tracking-widest text-[#2DD4BF] opacity-60 mt-auto">
                            {item.tech}
                        </div>
                    </div>
                ))}
