...
const HamburgerMenu = ({ isVisible, onClose }: HamburgerMenuProps) => {
    ...
    return (
        <>
            {/* Overlay */}
            <div
                className="fixed inset-0 bg-[#1E1E2E]/80 backdrop-blur-md z-[999] animate-[fade-in-overlay_0.3s_ease]"
                onClick={onClose}
            />

            {/* Menu */}
            <div className="fixed top-0 left-0 h-full w-[340px] max-w-[85vw] bg-gradient-to-b from-card to-background shadow-2xl z-[1000] flex flex-col animate-[slide-in-left_0.3s_ease] border-r border-border-custom text-white">
                ...
                <div className="bg-transparent pt-16 pb-8 px-6 relative overflow-hidden border-b border-white/10">
                    ...
                    >
                        <div className="relative mb-4">
                            <div className="w-20 h-20 rounded-2xl bg-card/10 flex items-center justify-center border-2 border-white/20 shadow-xl overflow-hidden">
                                {user?.profilePhoto ? (
                                    <img 
                            ...
                            <div className="absolute -bottom-1 -right-1 w-7 h-7 rounded-lg bg-primary flex items-center justify-center shadow-lg border-2 border-surface">
                ...
                <div className="flex-1 py-6 px-4 overflow-y-auto">
                    <p className="text-[10px] font-medium text-white/40 uppercase tracking-[0.2em] mb-4 px-4">Navigation</p>
                ...
                <div className="bg-black/20 px-6 py-6 space-y-4 border-t border-white/10">
                    ...
                    {!user && (
                        <button
                            className="w-full py-4 px-4 rounded-xl bg-gradient-to-r from-teal-600 to-teal-800 border-none flex items-center justify-center gap-3 cursor-pointer text-white shadow-lg transition-all duration-300 hover:translate-y-[-2px] hover:shadow-xl hover:from-teal-500 hover:to-teal-700"
